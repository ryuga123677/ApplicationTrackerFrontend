  ...
  axios.defaults.withCredentials=true;
    ...
    const getdetails = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/applications?search=${username}`);
    ...
    const deleteitem = async (id) => {
        const response = await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/applicationtobedeleted?id=${id}`);
