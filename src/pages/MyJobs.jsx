                ...
                <div className="w-[100%]">
                  <div className="flex justify-between items-center text-2xl text-[#21209C] ml-14">
                    ...
                    <div className="flex space-x-4">
                      <button className="text-sm text-sky-400" onClick={()=>navigate(`/applicantlist/${item._id}`)}>Applications</button>
                      <button className="text-md text-red-500"><TiDelete/></button>
                    </div>
                  </div>
